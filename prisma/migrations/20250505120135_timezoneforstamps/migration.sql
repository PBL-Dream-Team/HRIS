-- AlterTable
ALTER TABLE "AbsenceLeave" ALTER COLUMN "status_change_at" SET DATA TYPE TIMESTAMPTZ,
...
-- AlterTable
ALTER TABLE "Company" ALTER COLUMN "subs_date_start" SET DATA TYPE TIMESTAMPTZ,
ALTER COLUMN "subs_date_end" SET DATA TYPE TIMESTAMPTZ,
ALTER COLUMN "created_at" SET DEFAULT CURRENT_TIMESTAMP,
ALTER COLUMN "updated_at" SET DEFAULT CURRENT_TIMESTAMP;

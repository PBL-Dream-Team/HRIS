    ...
    return (
        <form onSubmit={handleSubmit} className={cn('flex flex-col gap-6', className)} {...props}>
            <div className="flex flex-col items-center gap-2 text-center">
                <h1 className="text-2xl font-bold">Create New a Company Name</h1>
                <p className="text-muted-foreground text-sm">
                    Please fill in the company details below to add a new company to the system.
                </p>
            </div>
            <div className="grid gap-6">
                <div className="grid gap-3">
                    <Label htmlFor="email" className="text-[#1E3A5F]">Company Name</Label>
                    <Input
                        id="email"
                        type="text"

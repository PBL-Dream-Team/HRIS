          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-8">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Kelola absensi, cuti, payroll, dan semua kebutuhan SDM dalam
                satu platform yang mudah digunakan dan hemat waktu.
              </p>
              <Link href="/signup">
        ...
        <section id="feature" className="py-24 bg-white px-4 md:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-gray-600 text-lg mb-12">
              Solusi lengkap untuk mengelola seluruh kebutuhan sumber daya
              manusia dalam satu platform.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
              <Card className="p-6 text-center transition-shadow hover:shadow-lg">
                ...
                <CardContent>
                  ...
                  <p className="text-gray-600 text-sm">
                    Kelola data karyawan secara terpusat, mulai dari biodata
                    hingga riwayat jabatan dan status aktif.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="p-6 text-center transition-shadow hover:shadow-lg">
                ...
                <CardContent>
                  ...
                  <p className="text-gray-600 text-sm">
                    Rekam kehadiran karyawan dengan sistem check-in/out online,
                    terintegrasi dengan lokasi dan waktu.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="p-6 text-center transition-shadow hover:shadow-lg">
                ...
                <CardContent>
                  ...
                  <p className="text-gray-600 text-sm">
                    Unggah, arsipkan, dan kelola dokumen penting seperti kontrak
                    kerja, surat cuti, dan lainnya.
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="flex justify-center flex-wrap gap-8">
              <Card className="p-6 text-center w-full max-w-sm transition-shadow hover:shadow-lg">
                ...
                <CardContent>
                  ...
                  <p className="text-gray-600 text-sm">
                    Kelola paket berlangganan perusahaan dan lakukan pembayaran
              ...
              <Card className="p-6 text-center w-full max-w-sm transition-shadow hover:shadow-lg">
                ...
                <CardContent>
                  ...
                  <p className="text-gray-600 text-sm">
                    Visualisasi data karyawan seperti performa, absensi, dan
                    distribusi jabatan dalam grafik yang informatif.
                  </p>
                </CardContent>
              </Card>
            </div>
